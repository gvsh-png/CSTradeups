      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 gap-3">
          <div className="flex items-center gap-2.5 min-w-0">
            <div className="w-7 h-7 shrink-0 rounded-md border border-accent/30 bg-accent/5 flex items-center justify-center">
              <svg
            ...
            <h1 className="text-sm font-semibold tracking-tight font-mono uppercase truncate">
